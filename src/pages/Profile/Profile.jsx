      ...
      <div className="grid w-4/6 grid-cols-4 gap-10 py-10 mx-auto">
        <div className="col-span-1">
          ...
          <div className="bg-[#1C1917] p-5 mt-5 rounded-2xl ">
            <div>
              <p className="text-lg font-semibold">Verified Info</p>
              <div className="flex items-center gap-5 py-4">
                <FaCircleCheck className="text-xl" />
                <p className="text-[#EBEEF2]">Email Address</p>
              </div>
            </div>
            <div className="my-5 bg-gray-400 border-b-[1px]" />
            <div>
              <p className="text-lg font-semibold">Verify Identity</p>
              <p className="text-[#EBEEF2] py-2 text-sm">
                Before Rent or Host on{" "}
                <span className="text-[#E11D48]">Homyz</span> you need to verify
                your identity first
              </p>
